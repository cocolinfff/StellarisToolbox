...
description:    "—£job_entertainer£ %job_entertainer_plural%额外产出§Y2§!£trade_value£ §Y%TRADE_VALUE%§!，但提供的£mod_planet_amenities_add£ %PLANET_AMENITIES_TITLE%§R-2§!并额外消耗§Y1§!£unity£ %unity%"
修正:{planet_entertainers_unity_upkeep_add:   1
swap_type:{description:    "—£job_duelist£ %job_duelist_plural%额外产出§Y2§!£trade_value£ §Y%TRADE_VALUE%§!，但提供的£mod_planet_amenities_add£ %PLANET_AMENITIES_TITLE%§R-2§!并额外消耗§Y1§!£unity£ %unity%"
name:    "商业化娱乐"
trigger:{is_duelist_country:   yes
hide_modifiers:   yes
前置条件:{ethics:{NOT:{value:    "完形意识"
随机权重:{base:   5
修正:{factor:   5
拥有思潮:    "个人主义"
...
前置条件:{origin:{NOT:{value:   origin_FBCIV_default
...
随机权重:{base:   @civic_uncommon_random_weight
modification:{add:{has_tradition:    "未来科技"
ai_weight:{修正:
factor:   @ai_civic_personality_match_factor
OR:{has_ai_personality:   decadent_hierarchy
...
前置条件:{政体:{NOT:{value:   auth_corporate
随机权重:{base:   1
修正:{has_civic:    "§E§H三倍利润§!§!"
factor:   50
拥有思潮:    "自由主义"
...
description:    "—£job_farmer£ %job_farmer%额外产出§Y4§!£trade_value£ %TRADE_VALUE%并§G+1%§!%mod_pop_lifestyle_trade_mult%\n—§Y农业§!区划将提供更少的岗位"
随机权重:{base:   5
修正:{factor:   5
拥有思潮:    "道德主义"
OR:{拥有思潮:
...
swap_type:{trigger:{is_duelist_country:   yes
...
description:    "—§Y%building_resource_silo%§!行星建筑额外§G+5000§!%MOD_COUNTRY_RESOURCE_MAX_ADD%，提高星球%MOD_PLANET_AMENITIES_MULT%并§G+1§!£job_warrior_drone£ %job_warrior_drone_plural%岗位\n—§Y%building_resource_silo%§!恒星基地建筑额外§G+5000§!%MOD_COUNTRY_RESOURCE_MAX_ADD%，并§G+1§!£unity£ %unity%\n—£building£§Y首都建筑§!提供的%MOD_COUNTRY_RESOURCE_MAX_ADD%翻倍"
...
修正:{planet_emigration_push_mult:   0.5
job_merchant_per_pop:   0.02
job_core_party_members_per_pop:   0.02
planet_jobs_slave_produces_mult:   0.1
country_pop_enslaved_mult:   0.15
leader_background_job_weight:{"grassroot_cadre":   0
merchant:   200
"labour_hero":   0
mogul:   200
trader:   100
hide_modifiers:   yes
前置条件:{civics:{NOT:{value:
   civic_galactic_sovereign_megacorp
    "§H§Y家族企业§!§!"
    "修正资本主义"
...
text:    "不接受任何程度的§Y排外主义§!"
description:    "—游戏开始时将有§Y1~5个§!随机文明获得这一国民理念，而这些文明将会互相取得通讯并组建一个['concept_common_ground_federation']。\n—开始游戏时解锁§Y%tech_xeno_linguistics%§!科技"
...
前置条件:{OR:{政体:{value:   auth_corporate
修正:{planet_orbital_bombardment_damage:   -0.25
...
需求:{ethics:{value:    "教权主义"
NOT:{value:    "个人主义"
description:    "—可以建造£building£ §Y%building_ranger_lodge%§!建筑，能够根据£blocker£ §Y星球自然障碍§!的数量添加£job_druid£ §Y%job_druid%§!岗位并提高%MOD_POP_CITIZEN_HAPPINESS%\n—建造§Y乐土园§!提供额外 £housing£ 住房，并提高 £unity£ 凝聚力产出\n—拥有特殊星球决策，可根除星球的异常，例如§Y危险野生动物§!、§Y苍茫大地§!、§Y变幻莫测的天气§!、§Y狂野之风§!、§Y生态受损§!、§Y辐照天地§!、§Y废土辐射§!\n—§Y采矿区划§!降低§R1§! £amenities£ 舒适度\n—不能使用§Y减少环境监管§!政策"
随机权重:{base:   15
修正:{factor:   5
拥有思潮:    "道德主义"
前置条件:{ethics:{NOT:{value:    "完形意识"
修正:{job_environmental_pollution_caused_mult:   -0.30
...
随机权重:{base:   @civic_default_random_weight
...
需求:{ethics:{value:    "集体主义"
OR:{value:
    "宪政主义"
    "自由主义"

text:    "是一定程度的§Y%ethic_fanatic_egalitarian%§!"
description:    "—当星球人口数量小于§Y50§!时，每个人口§G+2%§!%MOD_PLANET_BUILDING_BUILD_SPEED_MULT%。\n—国家灭亡时，如果该理念仍然生效，则会在一场革命中重生。\n—开始游戏时解锁§Y%tech_ascension_theory%§!科技。"
随机权重:{base:   0
swap_type:{trigger:{is_egalitarian:   yes
is_xenophobe:   no
has_tradition:    "未来社会"
...
前置条件:{ethics:{NOT:{value:    "完形意识"
修正:{pop_cat_worker_political_power:   1
...
修正:{planet_pops_consumer_goods_upkeep_mult:   -9.99
pop_growth_speed:   1
...
text:    "是一定程度的§Y%ethic_fanatic_materialist%§!"
description:    "—不能设置§Y军事电信§!政策\n—开始游戏时解锁§Y自动探索协议§!科技\n—§Y解锁舰船类型：§!私人殖民船"
随机权重:{base:   15
修正:{factor:   10
is_eager_explorer_empire:   yes
前置条件:{ethics:{NOT:{value:    "完形意识"
修正:{science_ship_survey_speed:   0.15
...
description:    "—将 £building£ §Y%building_bureaucratic_1%§!替换为§Y%building_planet_network_node%§!，替换 £job_bureaucrat£ §Y%job_bureaucrat_plural%§!岗位为 £job_democratic_politician£ §Y%job_democratic_politician_plural%§!岗位\n—开始游戏时解锁§Y%tech_auto_buildings%§!科技"
修正:{country_admin_cap_mult:   0.15
...
text:    "是一定程度的§Y%ethic_fanatic_capitalism%§!"
description:    "—每个£mod_planet_jobs_robotic_produces_mult£ 机器人口额外产出%r_unity%与%r_trade_value%。\n—与其他文明签订外交协议后，研究花费§G-50%§!。"
随机权重:{base:   @civic_default_random_weight
swap_type:{trigger:{any_country:{OR:{has_communications:   root
has_diplo_migration_treaty:   root
has_research_agreement:   root
is_in_federation_with:   root
前置条件:{species_archetype:{value:   MACHINE
ai_weight:{base:   @ai_civic_default_base_weight
修正:{planet_researchers_society_research_produces_add:   -2
...
text:    "是一定程度的§Y%ethic_fanatic_spiritualist%§!"
description:    "—£job_priest£ %job_priest_plural%会提供额外 £society£ 社会学研究和 £amenities£ 舒适度，并提供宜居度和£job_druid£ %job_druid_plural%岗位\n—£job_druid£ %job_druid_plural%将提供额外 £society£ 社会学研究和 £amenities£ 舒适度"
修正:{pop_amenities_usage_mult:   -0.15
...
text:    "是一定程度的§Y%ethic_fanatic_egalitarian%§!"
description:    "—§Y科学家§!初始拥有随机的§Y专精§!特质\n—§Y科学家§!有两倍的机会发现属于他们研究领域的技术"
随机权重:{base:   15
修正:{factor:   2
拥有思潮:    "自由主义"
前置条件:{政体:{NOT:{value:   auth_corporate
...
has_ascension_perk:   ev_land_planets
前置条件:{政体:{NOT:{value:   auth_corporate
修正:{planet_jobs_ruler_produces_mult:   0.15
pop_category_rulers_upkeep_mult:   0.1
councilor_exp_gain:   0.33
...
description:    "—£job_miner£ §Y%job_miner_plural%§!同时产出§G2§! £amenities£ 舒适度和§Y3§! £trade_value£ 贸易额"
随机权重:{修正:
factor:   0.5
拥有思潮:    "合作主义"
前置条件:{civics:{NOR:{value:
...
text:    "是一定程度的§Y%ethic_fanatic_capitalism%§!"
description:    "—§Y要塞§!和§Y堡垒§!建筑将£job_soldier£ %job_soldier% 岗位替换为£job_soldier£ %job_mercenary% 岗位，增加£mod_country_naval_cap_add£ §Y%MOD_COUNTRY_NAVAL_CAP_ADD%§!，生成£defense_army£ §Y防御部队§!并产出 £mod_trade_value_add£ %TRADE_VALUE%"
修正:{ARMY_STARTING_EXPERIENCE_ADD:   200
job_mercenary_add:   3
...
需求:{origin:{NOT:{value:   origin_synthetic_fertility
description:    "—未采纳这个国民文化的国家对该文明的§Y评价§!§R-40§!，采纳了%civic_liberty_of_libido%国民文化的国家对该文明的§Y评价§!§R-100§!\n—能够建造 £building£ §Y%building_equipment_breeding_plant%§!\n—%job_tentacle_seedbed_effect_desc%\n—开始游戏时拥有§Y%tech_cloning%§!科技"
随机权重:{base:   10
modification:{add:{has_tradition:    "未来科技"
...
修正:{starbase_building_build_speed_mult:   0.15
...
description:   "civic_machine_obsessional_directive_effects"
...
text:    "是一定程度的§Y%ethic_fanatic_authoritarian%§!"
description:    "—人口将额外提高§G%mod_planet_jobs_produces_mult%§!与§R%MOD_POP_GROWTH_SPEED_REDUCTION%§!。\n—§Y领袖§!开始将随机获得一系列的§Y心理特质§!。\n—开始游戏时解锁§Y%tech_selected_lineages%§!科技。"
...
拥有思潮:    "个人主义"
前置条件:{ethics:{NOT:{value:    "完形意识"
swap_type:{description:    "—提供特殊岗位：£job_professional_star_fans£ §Y%job_professional_star_fans_plural%§!，%job_professional_star_fans_effect_desc%\n—寺庙建筑将£job_priest£ §Y%job_priest_plural%§!替换为£job_manager£ §Y%job_manager_plural%§!和£job_duelist£ %job_duelist_plural%\n—可以使用 £unity£ 凝聚力招募§H圣战者§!陆军，他们脆弱但攻击力强且士气高昂。\n—§Y市场经济§!下, 无经济危机时, 提供§Y+0.2§!%economic_situation_improve%。"
name:    "无休之季"
trigger:{is_duelist_country:   yes
...
description:    "—开始游戏时解锁§Y%tech_decryption_1%§!与§Y%tech_decryption_2%§!科技"
修正:{trade_value_mult:   0.15
ship_cloaking_detection_add:   2
...
需求:{civics:{value:    "民主制"
description:    "—能够使用§B“为了人杈”§!战争理由\n—§R不能与战争中的国家签订§Y商业条约§!§!"
修正:{country_claim_influence_cost_mult:   -0.15
...
playable:{has_machine_age_dlc:   yes
前置条件:{政体:{value:   auth_machine_intelligence
ai_weight:{base:   @civic_rare_random_weight
修正:{councilor_gestalt_regulatory_exp_gain:   @gestalt_civic_node_xp_rate
envoys_add:   2
...
需求:{ethics:{value:    "崇外主义"
OR:{value:
    "道德主义"
    "教权主义"

description:    "—对§H非灭绝者文明§!的好感§G+1000§!\n—每个大使馆§G+10§! £unity£ 凝聚力\n—§Y失业人口§!额外产出§Y2§!£unity£ 凝聚力\n—不能§Y要求其他国家成为朝贡国§!\n—不能§Y关闭边界§!"
随机权重:{base:   75
修正:{factor:   0
NOT:{host_has_dlc:   "Utopia"
playable:{host_has_dlc:   "Utopia"
前置条件:{ethics:{NOT:{value:    "完形意识"
修正:{planet_pops_unemployed_consumer_goods_upkeep_add:   1
...
description:    "—开始游戏时无效果，之后每过§Y20§!年便有一次选择的机会，可选择保留该['concept_national_culture']或是移除该['concept_national_culture']以换取额外的%MOD_COUNTRY_GOVERNMENT_CIVIC_POINTS_ADD%。每一次选择保留则下一次可换取的%MOD_COUNTRY_GOVERNMENT_CIVIC_POINTS_ADD%§G+1§!，上限§Y10§!个。"
前置条件:{ethics:{NOT:{value:    "完形意识"
modification:   no
随机权重:{base:   1
修正:{factor:   0
...
需求:{ai_playable:{host_has_dlc:   "GalacticParagons"
随机权重:{base:   4
...
description:    "—§Y移民条约§!产生§G15§!£physics£ £society£ £engineering£ §Y研究点§!与§G30§! %r_unity%\n"
随机权重:{修正:
factor:   1.5
拥有思潮:    "宪政主义"
前置条件:{civics:{NOR:{value:
...
description:   "civic_tooltip_spirit_of_rule_by_man_effects"
...
description:    "—银河帝国内的所有国家将受到§Y革命宣传§!的影响"
随机权重:{base:   0
...
text:    "不接受任何程度的§Y自由主义§!"
修正:{planet_jobs_produces_mult:   0.33
...
text:    "是一定程度的§Y%ethic_fanatic_militarist%§!"
description:    "—£job_healthcare£ %job_healthcare_plural%额外产出§Y1.5§!£society£ 社会学研究\n—%javorian_pox_desc%\n—开始游戏时解锁§Y%tech_dangerous_wildlife%§!与§Y%tech_dense_jungle%§!科技"
...
修正:{country_resource_max_minor_artifacts_add:   2500
country_resource_max_astral_threads_add:   250
description:    "—§Y%building_resource_silo%§!行星建筑额外§G+5000§!%MOD_COUNTRY_RESOURCE_MAX_ADD%，提高星球%MOD_POP_CITIZEN_HAPPINESS%并§G+1§!£job_soldier£ %job_soldier_plural%岗位\n—§Y%building_resource_silo%§!恒星基地建筑额外§G+5000§!%MOD_COUNTRY_RESOURCE_MAX_ADD%，并§G+1§!£unity£ %unity%\n—£building£§Y首都建筑§!提供的%MOD_COUNTRY_RESOURCE_MAX_ADD%翻倍"
前置条件:{政体:{NOT:{value:   auth_corporate
随机权重:{base:   5
...
description:   "civic_tooltip_lord_of_feast_effects"
修正:{planet_farmers_food_produces_mult:   -1
planet_farmers_sr_dark_matter_produces_add:   0.5
...
text:    "是一定程度的§Y%ethic_fanatic_egalitarian%§!"
description:   "civic_tooltip_righteous_fury_effects"
前置条件:{civics:{NOR:{value:
   civic_galactic_sovereign_megacorp
    "§H§Y家族企业§!§!"
    "修正资本主义"
...
description:    "—£building£ §Y首都建筑§!会替换 £job_politician£ §Y%job_politician%§!岗位为 £job_trader£ §Y%job_trader_plural%§!岗位\n—每个£pops£ 人口额外§G+1%§!%MOD_TRADE_VALUE_MULT%\n—殖民星球后自动在新的殖民地开设§Y企业%BRANCH_OFFICES%§!\n—§Y解锁舰船类型：§!私人殖民船\n—§Y社会福利§!生活标准不可用"
随机权重:{base:   60
修正:{has_civic:   civic_empty_vagrant
factor:   0
NOR:{has_civic:   civic_ev_planet_and_fleet
...
has_ascension_perk:   ev_land_planets
前置条件:{政体:{NOT:{value:   auth_corporate
修正:{country_base_influence_produces_add:   -0.5
pop_growth_from_immigration:   0.15
...
description:    "—你的§Y附属国§!不能签订含有以下条款的协议：\n——%t%%TRIGGER_FAIL%§Y%subject_cannot_expand%§!\n——%t%%TRIGGER_FAIL%§Y允许宗主国不加入附属国战争§!\n——%t%%TRIGGER_FAIL%§Y%subject_can_not_do_diplomacy%§!"
随机权重:{base:   5
前置条件:{政体:{NOT:{value:   auth_corporate
修正:{empire_size_penalty_mult:   0.2
...
修正:{BIOLOGICAL_species_trait_points_add:   15
...
修正:{planet_pops_organics_minerals_upkeep_mult:   -0.2
planet_pops_consumer_goods_upkeep_mult:   -0.2
...
description:    "—§Y警署§!和§Y审判厅§!建筑提供额外的 £job_enforcer£ §Y%job_enforcer_plural%§!岗位"
修正:{trade_value_mult:   -0.25
...
需求:{civics:{NOT:{value:   civic_machine_terminator
description:   "civic_machine_tactical_algorithms_effects"
...
text:    "是一定程度的§Y%ethic_fanatic_authoritarian%§!"
description:    "—£building£ §Y首都建筑§!会替换部分 £job_politician£ §Y%job_politician%§!岗位为 £job_core_party_members£ §Y%job_core_party_members_plural%§!\n—§Y%pop_cat_ruler%§!阶级额外产出§Y2§! £unity£ 凝聚力\n—§Y奴隶§!人口额外产出§Y1§!£minerals£ %minerals%与£energy£ %energy%\n—不能使用§Y%trade_policy_unity%§!税收投资政策"
随机权重:{修正:
factor:   0.1
has_valid_civic:    "福利国家"
前置条件:{政体:{NOT:{value:   auth_corporate
修正:{leaders_cost_mult:   0.25
...
description:   "civic_hyperspace_specialty_effects"
ai_playable:{has_astral_planes_dlc:   yes
playable:{has_astral_planes_dlc:   yes
前置条件:{ethics:{NOT:{value:    "完形意识"
修正:{planet_sensor_range_add:   2
...
text:    "是一定程度的§Y%ethic_fanatic_militarist%§!"
description:    "—£job_soldier£ §Y%job_soldier_plural%§!与£job_conscript£ §Y%job_conscript_plural%§!产出£food£ 食物与£alloys£ 合金，以及少量£minerals£ 矿物、£energy£ 能量和£unity£ 凝聚力\n—动员出的部队将无需§Y维护费§!"
...
修正:{planet_building_build_speed_mult:   0.50
...
has_technology:   tech_ascension_theory
前置条件:{政体:{value:   auth_hive_mind
swap_type:{description:   "civic_tooltip_devouring_swarm_lithoid_effects"
...
description:    "—£building£§Y寺庙§!建筑额外提供£job_templar£ §Y%job_templar%§!岗位（结合§Y神权政治§!或§Y教权主义§!主题的国民理念可以让他们更强大）\n—£building£§Y祭祀之殿§!建筑额外提供£job_death_knight£ §Y%job_death_knight%§!岗位 \n—可以使用 £unity£ 凝聚力招募§H圣战者§!陆军，他们脆弱但攻击力强且士气高昂。\n—允许使用特殊凝聚力野望——§Y神圣远征§!\n—§Y%commander_plural_with_icon%§!初始拥有§Y%leader_trait_crusader%§!特质\n—仅限使用§Y解放战争§!政策"
修正:{army_attack_damage_mult:   0.2
...
text:    "是一定程度的§Y%ethic_fanatic_egalitarian%§!"
description:    "—替换 £job_manager£ §Y%job_manager_plural%§!岗位为 £job_clerk£ §Y%job_clerk%§!岗位， £job_clerk£ §Y%job_clerk%§!额外产出少量的§Y%MOD_COUNTRY_ADMIN_CAP_ADD%§!\n—开始游戏时解锁§Y%tech_effective_bureaucracy%§!科技"
前置条件:{OR:{政体:{value:   auth_corporate
随机权重:{修正:
factor:   2.5
拥有思潮:    "集体主义"
...
is_materialist:   yes
前置条件:{政体:{NOT:{value:   auth_corporate
修正:{country_admin_cap_mult:   0.25
...
description:    "—£job_bio_trophy£ §Y%citizenship_organic_trophy%§!或£job_organic_observer£ §Y%job_organic_observer_plural%§!额外产出少量的£energy£ %energy%、£minerals£ %minerals%、£food£ %food%、£consumer_goods£ %consumer_goods%与£alloys£ %alloys%"
随机权重:{base:   15
...
text:    "是一定程度的§Y%ethic_fanatic_spiritualist%§!"
description:    "—£job_priest£ %job_priest_plural%岗位的£unity£ 凝聚力产出降低，但产出£society£ 社会学研究、£physics£ 物理学研究和£engineering£ 工程学研究\n—允许使用特殊法令——§Y文物研究§!\n—£job_priest£ %job_priest%岗位和£job_researcher£ %job_researcher_plural%不会互相产生干扰"
随机权重:{修正:
factor:   10
拥有思潮:    "崇外主义"
前置条件:{ethics:{NOT:{value:    "完形意识"
...
修正:{country_starbase_capacity_mult:   0.50
...
前置条件:{政体:{value:   auth_machine_intelligence
ai_weight:{base:   @ai_civic_uncommon_base_weight
...
description:    "—£job_priest£ %job_priest_plural%会额外产出§Y1§! £unity£ 凝聚力和 £amenities£ 舒适度，并提供%MOD_POP_GROWTH_SPEED%\n—£job_high_priest£ %job_high_priest_plural%提供额外 £society£ 社会学研究和 £amenities£ 舒适度"
修正:{pop_amenities_usage_mult:   -0.1
pop_growth_speed:   0.1
...
拥有思潮:    "合作主义"
前置条件:{政体:{NOT:{value:   auth_corporate
修正:{citizen_pop_same_species_class_happiness:   0.025
...
需求:{政体:{value:    "世袭专制"
description:    "—£building£ §Y首都建筑§!会替换 £job_politician£ §Y%job_politician%§!岗位为 £job_executive£ §Y%job_executive_plural%§!\n—§Y奴隶§!人口额外产出§Y0.5§!£trade_value£ %TRADE_VALUE%\n—国家类型将被视为§Y%auth_corporate%§!\n—殖民星球后自动在新的殖民地开设§Y企业%BRANCH_OFFICES%§!"
随机权重:{base:   60
修正:{has_civic:   civic_empty_vagrant
factor:   0
NOR:{has_civic:   civic_ev_planet_and_fleet
...
has_ascension_perk:   ev_land_planets
前置条件:{ethics:{NOT:{value:    "完形意识"
修正:{branch_office_value_mult:   0.25
...
text:    "是一定程度的§Y%ethic_fanatic_pacifist%§!"
description:    "—开始游戏时解锁§Y文化遗址§!科技，§Y教权主义§!开始游戏时解锁§Y全息仪式§!科技"
随机权重:{base:   10
修正:{factor:   3
拥有思潮:    "道德主义"
NOT:{拥有思潮:    "权威主义"
...
修正:{planet_pops_upkeep_mult:   0.25
...
需求:{ethics:{NOR:{value:    "集体主义"
description:    "—§Y住房区划§!额外提供£trade_value£ %TRADE_VALUE%，但§R减少§!£housing£ %PLANET_HOUSING_TITLE%\n—§Y住房建筑§!额外提供£job_manager£ %job_manager_plural%岗位，但增加§R1§!£crime£ %PLANET_CRIME_TITLE%"
随机权重:{base:   5
修正:{factor:   4
拥有思潮:    "个人主义"
前置条件:{civics:{NOR:{value:
...
修正:{pop_government_ethic_attraction:   0.15
planet_stability_add:   10
...
description:    "—§Y保障独立§!和§Y互不侵犯条约§!不需要影响力维护\n—§Y革命者派系§!对§Y防御条约§!给予支持\n—开始游戏时解锁%continuous_revolution%政策\n—§Y轨道轰炸§!选项受限\n—仅限使用§Y解放战争§!政策"
随机权重:{base:   30
前置条件:{ethics:{NOT:{value:    "完形意识"
修正:{country_power_projection_influence_produces_add:   1
country_war_exhaustion_mult:   -0.25
...
text:    "是一定程度的§Y%ethic_fanatic_materialist%§!"
description:    "—£job_merchant£ %job_merchant_plural%、£job_manager£ %job_manager_plural%和£job_trader£ %job_trader_plural%额外生产£physics£ £society£ £engineering£\n—£job_researcher£%job_researcher_plural%岗位提供额外的£trade_value£ %TRADE_VALUE%\n—开始游戏时解锁%trade_policy_unity%政策\n—§Y市场经济§!下, 无经济危机时, 提供§Y+0.1§!%economic_situation_improve%和§Y+40§!%economic_crisis_threshold%。"
...
修正:{spy_network_daily_value_mult:   0.33
...
修正:{country_starbase_influence_cost_mult:   -0.33
...
hide_modifiers:   yes
前置条件:{政体:{NOT:{value:   auth_corporate
修正:{planet_building_mage_tower_2_build_speed_mult:   0.25
...
修正:{planet_shared_burden_jobs_produces_mult:   -0.1
...
需求:{ethics:{NOR:{value:    "个人主义"
description:    "—可以建造£building£ §Y%building_ranger_lodge%§!建筑，能够根据£blocker£ §Y星球自然障碍§!的数量添加£job_ranger£ §Y%job_ranger%§!岗位并提供额外£housing£ §Y住房§!\n—£job_ranger£ §Y%job_ranger_plural%§!产出£society£ §Y社会学研究§!以及%r_amenities%"
...
text:    "是一定程度的§Y%ethic_fanatic_materialist%§!"
description:    "—§Y研究中心§!建筑产出额外£unity£ 凝聚力"
随机权重:{base:   10
修正:{factor:   2.5
拥有思潮:    "集体主义"
前置条件:{civics:{NOR:{value:
...
修正:{job_researcher_per_pop:   0.03
...
需求:{description:   "civic_tooltip_franchising_effects"
...
description:   "civic_Joker_effects"
前置条件:{civics:{NOR:{value:
   civic_galactic_sovereign_megacorp
    "§H§Y家族企业§!§!"
    "修正资本主义"
...
has_ascension_perk:   ev_land_planets
前置条件:{政体:{NOT:{value:   auth_corporate
修正:{country_war_exhaustion_mult:   -0.15
...
text:    "是一定程度的§Y%ethic_fanatic_pacifist%§!"
description:   "civic_tooltip_conservative_armament_effects"
...
修正:{planet_enforcers_unity_produces_add:   -1
local_trade_protection_add:   5
planet_enforcers_upkeep_mult:   0.15
ship_piracy_suppression_add:   5
pop_ethic_socialism_attraction_mult:   -0.15
description:    "—£job_enforcer£ §Y%job_enforcer_plural%§!额外产出§Y2§! £trade_value£ 贸易额\n—§Y警署§!和§Y审判厅§!建筑提供额外的 £job_enforcer£ §Y%job_enforcer_plural%§!岗位"
前置条件:{OR:{政体:{value:   auth_corporate
需求:{ethics:{value:    "个人主义"
NOR:{value:
    "道德主义"
    "自由主义"
...
修正:{country_sr_dark_matter_produces_mult:   0.15
...
description:    "—£building£ §Y%building_organic_sanctuary%§!与£building£ §Y%building_organic_paradise%§!将提供额外的£amenities£ %MOD_PLANET_AMENITIES_ADD%，并且每个£job_maintenance_drone£ §Y%job_maintenance_drone_plural%§!§G+1%§!%MOD_POP_HAPPINESS%\n—允许建造£building£ §Y%building_gaiaseeders%§!建筑\n—开始游戏时解锁§Y%tech_terrestrial_sculpting%§!与§Y%tech_paradise_dome%§!科技"
随机权重:{base:   5
前置条件:{OR:{政体:{value:   auth_machine_intelligence
修正:{councilor_gestalt_growth_exp_gain:   @gestalt_civic_node_xp_rate
...
text:    "是一定程度的§Y%ethic_fanatic_materialist%§!"
description:    "—£building£ §Y研究建筑§!额外提供£job£ 岗位并提高£happiness£ %MOD_POP_CITIZEN_HAPPINESS%。\n—£job_labour_hero£ §Y%job_labour_hero_plural%§!的岗位产出替换为£physics£ £society£ £engineering£ 研究点数。\n—解锁['concept_unique_technology']：%civic_OGAS%"
随机权重:{base:   25
前置条件:{ethics:{NOT:{value:    "完形意识"
修正:{planet_researchers_society_research_produces_add:   1.5
...
text:    "是一定程度的§Y%ethic_fanatic_egalitarian%§!"
description:    "—解锁§Y权力平衡§!法案，三种权力分别带来三种不同侧重的加成：\n——§G立法权§!：法令颁布与法令开销\n——§R司法权§!：遏制犯罪与稳定社会\n——§E行政权§!：国家治理与生产管理"
前置条件:{政体:{NOT:{value:   auth_corporate
随机权重:{base:   10
修正:{factor:   2.5
拥有思潮:    "个人主义"
...
text:    "不接受任何程度的§Y排外主义§!"
description:    "—£job_colonist£ §Y%job_colonist_plural%§!同时产出 §Y5§! £unity£ 凝聚力\n—开始游戏时解锁§Y星际野望§!科技"
随机权重:{base:   15
修正:{factor:   10
is_eager_explorer_empire:   yes
前置条件:{ethics:{NOT:{value:    "完形意识"
...
text:    "是一定程度的§Y%ethic_fanatic_militarist%§!"
description:    "—替换 £job_entertainer£ §Y%job_entertainer%§!岗位为 £job_duelist£ §Y%job_duelist%§!岗位，%job_duelist_effect_desc%\n—开始游戏时解锁§Y集中指挥§!科技"
...
text:    "是一定程度的§Y%ethic_fanatic_materialist%§!"
description:   "civic_tooltip_the_song_of_gears_effects"
...
前置条件:{政体:{value:   auth_hive_mind
ai_weight:{base:   @ai_civic_default_base_weight
修正:{factor:   @ai_civic_personality_match_factor
...
has_ascension_perk:   ev_land_planets
前置条件:{政体:{NOT:{value:   auth_corporate
修正:{pop_factions_produces_mult:   -0.15
...
description:   "civic_tooltip_juvenile_culture_effects"
前置条件:{ethics:{NOT:{value:    "完形意识"
修正:{category_particles_research_speed_mult:   0.15
...
description:    "—当星球上的%POPULATION_BUTTON%、§H%BUILDINGS_TITLE%§!与§H%DISTRICTS%§!数量为§Y42§!时，%mod_planet_jobs_produces_mult%与%mod_planet_buildings_produces_mult%将分别提高§G42%§!。\n—每隔§Y42§!年，所有星球的%r_trade_value%都将提高§G42§!倍，持续一整年。"
随机权重:{base:   1
modification:{add:{has_tradition:    "未来科技"
has_technology:   tech_ascension_theory
前置条件:{ethics:{NOT:{value:    "完形意识"
<span title=civic_task_delegation_corporate style="border-bottom:1px dotted">civic_task_delegation_corporate</span>
需求:{ethics:{NOT:{value:    "自由主义"
ai_playable:{host_has_dlc:   "GalacticParagons"
随机权重:{base:   4
playable:{host_has_dlc:   "GalacticParagons"
前置条件:{OR:{政体:{value:   auth_corporate
...
has_ascension_perk:   ev_land_planets
前置条件:{政体:{NOT:{value:   auth_corporate
修正:{tradition_cost_empire_size_mult:   -0.5
...
需求:{description:    "—每读取存档一次，人口思潮将随机刷新一次\n—每读取存档一次，国家政体与国民理念将随机变化一次"
修正:{modification:   no
前置条件:{ethics:{NOT:{value:    "完形意识"
随机权重:{base:   0
...
text:    "是一定程度的§Y%ethic_fanatic_capitalism%§!"
description:    "—通过§Y增强投标§!，他们的星球有更高的几率被提名主持§Y银河市场§!，使用§Y增强提名投标§!花费更少的影响力\n—§Y商业协议§!不需要花费影响力维持\n—提高§Y贸易联盟§!飞地的评价\n—§Y企业家派系§!对§Y贸易联邦§!提供额外支持"
随机权重:{base:   15
前置条件:{ethics:{NOT:{value:    "完形意识"
...
planet_miners_minor_artifacts_produces_add:   0.5
...
text:    "是一定程度的§Y%ethic_fanatic_militarist%§!"
description:    "—£job_foundry£ %job_foundry_plural%能够增加%MOD_ARMY_STARTING_EXPERIENCE_ADD%"
随机权重:{base:   10
修正:{factor:   5
拥有思潮:    "自由主义"
前置条件:{ethics:{NOT:{value:    "完形意识"
...
description:    "—£job_farmer£ §Y%job_farmer_plural%§!同时产出§G3§! £amenities£ 舒适度和§Y2§! £trade_value£ 贸易额"
leader_background_job_weight:{"farmer":   50
修正:{farming_district_buildings_add:   0.34
generator_district_housing_add:   1
farming_district_housing_add:   1
...
text:    "是一定程度的§Y%ethic_fanatic_authoritarian%§!"
修正:{pop_cat_ruler_happiness:   0.1
...
修正:{country_unity_produces_mult:   0.05
planet_crime_mult:   -0.2
empire_size_pops_mult:   -0.15
pop_ethic_socialism_attraction_mult:   0.15
...
修正:{country_starbase_capacity_add:   5
...
随机权重:{base:   5
前置条件:{政体:{value:   auth_machine_intelligence
修正:{country_edict_fund_mult:   0.25
...
text:    "是一定程度的§Y%ethic_fanatic_spiritualist%§!"
description:    "—寺庙建筑额外提供 £job_transcend£ %job_transcend%岗位，产生少量 £unity£ 凝聚力，£society£ 社会学研究和£engineering£ 工程学研究，并减少§Y£crime£ %PLANET_CRIME_TITLE%§!\n—出现§Y灵能理论§!科技选项的概率提高"
...
description:    "—£job_artisan£ %job_artisan_specialist_plural%与£job_artisan£ %job_artisan_plural%额外产出£trade_value£ %TRADE_VALUE%\n—§Y工业区划§!提供额外 £job_trader£ %job_trader_plural%岗位\n—§Y商业区§!、§Y商业复合体§!建筑和§Y城市区划§!提供额外£job_artisan£ %job_artisan_plural%岗位\n—§Y企业家派系§!会因§Y加强环境监管§!政策不悦，对§Y轻工业补贴§!税收投资政策感到愉悦\n—§Y市场经济§!下, 无经济危机时, 提供§Y+0.3§!%economic_situation_improve%。"
随机权重:{base:   10
修正:{factor:   5
拥有思潮:    "个人主义"
前置条件:{ethics:{NOT:{value:    "完形意识"
修正:{pop_category_specialists_consumer_goods_upkeep_add:   0.75
...
text:    "是一定程度的§Y%ethic_fanatic_xenophobe%§!"
description:    "—§R谁都不知道这个“灵活的标准程序”到底有什么存在的意义，我也一样。§!"
前置条件:{政体:{NOT:{value:   auth_corporate
随机权重:{base:   0
...
description:   "civic_tooltip_echoes_of_suffering_effects"
ai_playable:{host_has_dlc:   "HumanoidsSpeciesPack"
playable:{host_has_dlc:   "HumanoidsSpeciesPack"
前置条件:{ethics:{NOT:{value:    "完形意识"
随机权重:{base:   5
...
text:    "是一定程度的§Y%ethic_fanatic_egalitarian%§!"
description:    "—在§Y联邦§!中时，维持§Y互不侵犯协定§!和§Y研究协议§!不花费影响力 \n—在§Y联邦§!中时§Y异族主义§!派系提供额外的认同 \n—成功的§Y提升土著§!给予10年帝国范围修正，提高 £unity£ 凝聚力和 £society£ 社会学研究\n—不能拥有§Y宿敌§!"
随机权重:{base:   25
前置条件:{ethics:{NOT:{value:    "完形意识"
修正:{envoy_improve_relations_mult:   0.15
diplo_weight_mult:   0.25
diplomacy_upkeep_mult:   -0.15
country_border_friction_mult:   -0.5
envoys_add:   3
...
text:    "是一定程度的§Y%ethic_fanatic_spiritualist%§!"
description:    "—£job_priest£ §Y%job_priest_plural%§!能够提高§Y%pop_cat_worker%§!阶级的£happiness£§Y幸福度§!，同时额外产出少量的 £minerals£ 矿物，£food£ 食物和 £unity£ 凝聚力\n—§Y%pop_cat_worker%§!阶级额外产出§Y0.25§!£unity£ 凝聚力，并额外消耗§Y0.15§!£consumer_goods£ 消费品\n—§Y宗教派系§!会因§Y社会平等§!或§Y乌托邦§!生活标准感到愉悦"
随机权重:{修正:
factor:   3
拥有思潮:    "宪政主义"
前置条件:{ethics:{NOT:{value:    "完形意识"
...
需求:{ethics:{value:    "机械主义"
description:    "—可以建造£building£ §Y%building_ranger_lodge%§!建筑，能够根据£blocker£ §Y星球自然障碍§!的数量提供£job_geoengineer£ §Y%job_geoengineer%§!岗位和£job_xenobiologist£ §Y%job_xenobiologist%§!岗位，并增加%MOD_PLANET_MAX_BUILDINGS_ADD%\n—允许使用特殊的星球决议，以根除星球的异常，例如§Y辐照天地§!、§Y潮汐锁定§!、§Y生态受损§!等等\n—能够通过星球决议添加£blocker£ §Y星球自然障碍§!\n—开始游戏时解锁§Y地表塑造§!科技"
随机权重:{base:   5
modification:{add:{has_tradition:    "未来科技"
前置条件:{ethics:{NOT:{value:    "完形意识"
修正:{terraforming_cost_mult:   -0.33
...
text:    "是一定程度的§Y%ethic_fanatic_militarist%§!"
description:    "—每摧毁一支敌军舰队，则%pop_citizen_happiness%§G+15%§!，持续一年。\n—每当自己的一支舰队被摧毁，则%pop_citizen_happiness%§R-15%§!，持续一年。"
随机权重:{base:   30
前置条件:{ethics:{NOT:{value:    "完形意识"
修正:{country_claim_influence_cost_mult:   -0.2
country_war_exhaustion_mult:   -0.25
diplo_weight_naval_mult:   0.15
...
has_technology:   tech_ascension_theory
前置条件:{政体:{NOT:{value:   auth_corporate
修正:{council_agenda_finishing_effect_duration_mult:   0.15
...
随机权重:{base:   30
前置条件:{ethics:{NOT:{value:    "完形意识"
修正:{country_vassal_naval_capacity_contribution_mult:   0.33
